...
Theme [**color palettes**](http://www.google.com/design/spec/style/color.html#color-ui-color-palette), alphas, and shadows deliver a consistent tone to your application and a unified feel for all ct UI components.

Theming allows changing the color of your ct application. If you
...
ct makes it easy to design an app which follows the Material style
...
This concept is central to how ct approaches theming.
...
A palette is a collection of hues. By default, ct ships with all
...
Valid color intentions in ct include:
