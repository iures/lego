...
If you have questions or ideas regarding ct, please direct these to the
[ct Forum](https://groups.google.com/forum/#!forum/ngmaterial).
...
* **Major Changes** that you wish to contribute to the project should be discussed first on our
  [ct Forum](https://groups.google.com/forum/#!forum/ngmaterial), so that we can better
...
* **ct Version** - check the header of your `ct.js` file to determine
...
* All contributions must be consistent with the ct coding conventions. See the
...
important to note that we use the git commit messages to **generate** the ct
